...
- [ ] **Add MIDI filename as export title with manual override**: Display the MIDI filename as a title on exports, with an editable text field to customize the title before export. See [`plans/2026-07-22-export-title.md`](../plans/2026-07-22-export-title.md).
...
- [ ] **Extend the dynamic composition layout engine**: Current uniform bounds-fit, centering, safe padding, and overflow prevention apply to preview and exports. Add optional pan/zoom and composition-aware placement controls. Enable dynamic auto-zoom to stay tight on active region throughout track and zoom out as necessary.
- [ ] **Allow zoom and pan on the plot**: Add interactive zoom and pan controls for the SVG plot visualization, enabling users to explore music scores at different scales and positions before export. Enable dynamic auto-zoom to stay tight on active region throughout track and zoom out as necessary.
