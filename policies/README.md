...
| [github-repository-hygiene.md](github-repository-hygiene.md) — default-branch rulesets, reviews/checks, GitHub security, and secrets/absolute-path gates | GitHub settings + hooks + required CI |
